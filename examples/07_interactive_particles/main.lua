...
function M.init()
    ...
    local res_pBuf = graph:register_resource("ParticleBuffer", render_graph.TYPE_BUFFER, particle_buffer.handle)
    local res_attr = graph:register_resource("AttrBuffer", render_graph.TYPE_BUFFER, attractor_buffer.handle)
